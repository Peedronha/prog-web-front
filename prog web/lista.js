document.addEventListener('DOMContentLoaded', () => {
    ...
    const atividadesFixas = [
        { id: 1, name: 'Atividade 1', price: 'R$ 50,00' },
        { id: 2, name: 'Atividade 2', price: 'R$ 80,00' }
    ];
    ...
    function carregarTabela() {
        ...
        atividades.forEach(item => {
            ...
            tr.innerHTML = `
                ...
                <td>${item.price}</td>
                <td>
                    <button class="btn btn-edit" onclick="editarAtividade(${item.id}, '${item.name}', '${item.price}')">Editar</button>
    ...
    window.editarAtividade = (id, nome, preco) => {
